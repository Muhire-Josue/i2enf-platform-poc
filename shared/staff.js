...
NAV_ITEMS.staff = [
  ...
  { page: 'matching', href: 'matching/dashboard.html', key: 'app_nav_matching', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><circle cx="7" cy="8" r="3"/><circle cx="17" cy="8" r="3"/><path d="M2 20v-1a5 5 0 015-5h1M22 20v-1a5 5 0 00-5-5h-1"/><path d="M10 17h4M12 15v4"/></svg>' },
